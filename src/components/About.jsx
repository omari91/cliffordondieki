        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-4 text-gray-600 leading-relaxed">
              Passionate about transforming healthcare with technology and social innovation.
              Dedicated to building digital health solutions that improve patient outcomes and streamline operations.
            </p>
            ...
            >
              {[
                { value: "10+", label: "Years Experience", color: "text-blue-500" },
